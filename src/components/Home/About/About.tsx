    ...
    <div className='pt-16 pb-16 bg-[#050709]'>
      ...
      <div className='w-[80%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mt-20'>
        ...
        <div  data-aos="zoom-in" data-aos-anchor-placement="top-center" data-aos-delay="150" className='grid grid-cols-2 gap-16 items-center lg:mx-auto'>
          {/* 1st Stat */}
          <div>
            <Image src="/images/customer.png" alt="image" width={80} height={8} className="mx-auto" />
          ...
          <p className='text-base sm:text-lg text-gray-400 text-center'>
            ...
            {/* 2nd Stat */}
          <div>
            <Image src="/images/experience.png" alt="image" width={80} height={8} className="mx-auto" />
          <p className='mt-3 font-bold text-xl text-white text-center'>
          ...
          <p className='text-base sm:text-lg text-gray-400 text-center'>
            ...
            {/* 3rd Stat */}
          <div>
            <Image src="/images/completed.png" alt="image" width={80} height={8} className="mx-auto" />
          <p className='mt-3 font-bold text-xl text-white text-center'>
            {aboutInfo.project}
            </p>
          <p className='text-base sm:text-lg text-gray-400 text-center'>
            ...
            {/* 4th Stat */}
          <div>
            <Image src="/images/rocket.png" alt="image" width={80} height={8} className="mx-auto" />
          <p className='mt-3 font-bold text-xl text-white text-center'>
            {aboutInfo.website}
            </p>
          <p className='text-base sm:text-lg text-gray-400 text-center'>
